...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property AddressbookId = new Property(3, long.class, "addressbookId", false, "ADDRESSBOOK_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONTACT\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"EMAIL\" TEXT," + // 2: email
                "\"ADDRESSBOOK_ID\" INTEGER NOT NULL );"); // 3: addressbookId
    }
    ...
    public List<Contact> _queryAddressBook_ContactList(long addressbookId) {
        synchronized (this) {
